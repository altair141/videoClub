...
class Domicilio extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('direccion, ciudad, regionid, personaid', 'required'),
			array('regionid, personaid', 'numerical', 'integerOnly'=>true),
			array('direccion, ciudad', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, direccion, ciudad, regionid, personaid', 'safe', 'on'=>'search'),
		);
	}
