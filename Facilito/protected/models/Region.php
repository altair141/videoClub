...
class Region extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nombreRegion, provinciaid', 'required'),
			array('provinciaid', 'numerical', 'integerOnly'=>true),
			array('nombreRegion', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, nombreRegion, provinciaid', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'domicilios' => array(self::HAS_MANY, 'Domicilio', 'regionid'),
	...
	public function search()
	{
		...
		$criteria->compare('nombreRegion',$this->nombreRegion,true);
